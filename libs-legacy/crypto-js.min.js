...
!function (t, e) {
  ...
  u = u.SHA512 = H1.extend({
    ...
    _doProcessBlock: function _doProcessBlock(W, O) {
  ...
  u = u.SHA3 = F1.extend({
    ...
    execute: function execute(t, e, r, i, o) {
  ...
  var p2 = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
    u = u.AES = p.extend({
      ...
      _doCryptBlock: function _doCryptBlock(t, e, r, i, o, n, s, c) {
  ...
  {
    var C2 = function C2(t, e) {
      var r = t.sbox[0][e >> 24 & 255] + t.sbox[1][e >> 16 & 255];
      return r = (r ^= t.sbox[2][e >> 8 & 255]) + t.sbox[3][255 & e];
    };
    var R2 = function R2(e, t, r) {
      var i = t,
        o = r,
        n;
      for (var _t = 0; _t < F; ++_t) i ^= e.pbox[_t], o = C2(e, i) ^ o, n = i, i = o, o = n;
        ...
        if (this._keyPriorReset !== this._key) {
            ...
            t = t.sigBytes / 4;
          {
            ...
            for (var _e = 0; _e < 4; _e++) {
              s.sbox[_e] = [];
              for (var _t2 = 0; _t2 < 256; _t2++) s.sbox[_e][_t2] = E2[_e][_t2];
            }
            var _e2 = 0;
            for (var _t3 = 0; _t3 < F + 2; _t3++) s.pbox[_t3] = D2[_t3] ^ c[_e2], ++_e2 >= a && (_e2 = 0);
            var _r = 0,
              _i = 0,
              _o = 0;
            for (var _t4 = 0; _t4 < F + 2; _t4 += 2) _o = R2(s, _r, _i), _r = _o.left, _i = _o.right, s.pbox[_t4] = _r, s.pbox[_t4 + 1] = _i;
            for (var _e3 = 0; _e3 < 4; _e3++) for (var _t5 = 0; _t5 < 256; _t5 += 2) _o = R2(s, _r, _i), _r = _o.left, _i = _o.right, s.sbox[_e3][_t5] = _r, s.sbox[_e3][_t5 + 1] = _i;
          }
        }
      },
      encryptBlock: function encryptBlock(t, e) {
      ...
      decryptBlock: function decryptBlock(t, e) {
        var r = function (e, t, r) {
          var i = t,
            o = r,
            n;
          for (var _t6 = F + 1; 1 < _t6; --_t6) i ^= e.pbox[_t6], o = C2(e, i) ^ o, n = i, i = o, o = n;
