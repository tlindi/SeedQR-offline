...
if (typeof HTMLCollection !== 'undefined' && !HTMLCollection.prototype.forEach) {
  HTMLCollection.prototype.forEach = function (callback, thisArg) {
    if (this == null) {
      throw new TypeError('HTMLCollection.prototype.forEach called on null or undefined');
    }
    var T = thisArg || window;
    for (var i = 0; i < this.length; i++) {
      callback.call(T, this[i], i, this);
...
(function () {
  ...
  if (typeof window.TextEncoder === 'undefined') {
    var TextEncoderPoly = function TextEncoderPoly() {};
  ...
  if (typeof window.TextDecoder === 'undefined') {
    var TextDecoderPoly = function TextDecoderPoly() {};
